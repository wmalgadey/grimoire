...
<Why this one boundary or technology decision is needed now; the forces in tension. Scoped to
exactly one aspect — see Constitution Principle III, "Single-aspect ADRs; no feature content.">
...
- Tag each Boundary Rule or Feature-Scoped Invariant this ADR introduces, per Constitution
  Principle III's "Structural boundary tests" / "Feature-Scoped Invariants" categories.
...
- **Extensions (do not invalidate this ADR):** <foreseeable uses of this decision that stay within
  what it decided — no ADR action needed when they occur>.
- **Invalidations (would require full supersession):** <foreseeable changes that would reverse,
  narrow, or contradict this decision — any of these retires this ADR wholesale via a new
  Superseding ADR, per Constitution Principle III, "Whole-ADR supersession, bidirectionally
  linked">.
