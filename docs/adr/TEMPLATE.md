...
<Why this one boundary or technology decision is needed now; the forces in tension. Scoped to exactly one aspect — see Constitution Principle III, "Single-aspect ADRs; no feature content.">
...
- Tag each Boundary Rule or Feature-Scoped Invariant this ADR introduces, per Constitution Principle III's "Structural boundary tests" / "Feature-Scoped Invariants" categories.
...
<Cross-references to other ADRs this one depends on or is expected to be read alongside. MUST NOT restate or narrow their decisions — see Constitution Principle III's "Extension is not invalidation.">
