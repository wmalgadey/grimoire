...
| Synthesis-page confidence treatment (FR-006a) | `QUERY` | — | — | **state** — the shared formula applied to the provenance of the pages a synthesis draws on ([data-model.md](../data-model.md)), never a narrative carve-out. No aggregation rule is prescribed: where the inherited signals disagree, the weighting is the agent's judgment |
