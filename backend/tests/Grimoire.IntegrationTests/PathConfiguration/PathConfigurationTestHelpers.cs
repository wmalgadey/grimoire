...
internal static class PathConfigurationTestHelpers
{
    ...
    public static SeededRequiredInputs SeedRequiredInputsWithPaths(string baseDir)
    {
        ...
        var seeded = SeedRequiredInputFiles(baseDir, agentWorker);
        var options = new GrimoirePathOptions { BaseDir = baseDir, AgentWorker = agentWorker };
    ...
    public static GrimoirePathOptions SeedRequiredInputsForZeroConfig(string cwd)
    {
        ...
        SeedRequiredInputFiles(cwd, agentWorker);
        return new GrimoirePathOptions { AgentWorker = agentWorker };
    }

    private static SeededRequiredInputs SeedRequiredInputFiles(string baseDir, string agentWorker)
    {
