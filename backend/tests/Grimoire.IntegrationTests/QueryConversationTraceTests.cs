...
public class QueryConversationTraceTests
{
    ...
    public async Task LoadConversationContextSpan_IsChildOfSubmit_WithConversationTurnCountAndSourceAttributes()
    {
        ...
        var turnId = await ConversationRecordLifecycleTests.SubmitAsync(client, "c-trace-load", "What decisions exist?");
    ...
    public async Task RecordTurnSpan_IsChildOfRunSupervision_ForSupervisionDetectedTerminal_WithCorrelatedAttributes()
    {
        ...
        var turnId = await ConversationRecordLifecycleTests.SubmitAsync(client, "c-trace-record", "What decisions exist?");
        await ConversationRecordLifecycleTests.WaitForStateAsync(client, turnId, "completed");
    ...
    public async Task RecordTurnSpan_OnUserInterruption_IsParentedByTheInterruptHttpRequest_NotRunSupervision()
    {
        ...
        var turnId = await ConversationRecordLifecycleTests.SubmitAsync(client, "c-trace-interrupt", "Interrupt me?");
