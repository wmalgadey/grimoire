...
public class QueryTurnSubmissionApiTests
{
    ...
    public async Task PostTurn_FollowUpWithPromptOnlyBody_GetsHubAssignedPosition()
    {
        ...
        var firstTurnId = await ConversationRecordLifecycleTests.SubmitAsync(client, "c-position", "First question?");
        await ConversationRecordLifecycleTests.WaitForStateAsync(client, firstTurnId, "completed");
